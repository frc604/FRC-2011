...
void _GLOBAL__I__ZN7Command11InitCommandEPcd();

void _GLOBAL__I__ZN12PrintCommandC2EPc();

void _GLOBAL__I__ZN9Scheduler8instanceE();

void _GLOBAL__I_wpi_error_s_IndexOutOfRange();

void _GLOBAL__I__ZN9RobotBase10m_instanceE();

void _GLOBAL__I__ZN14SmartDashboard7putDataEPcP18SmartDashboardData();
...
void (*_ctors[])() =
    ...
    _GLOBAL__I__ZN7Command11InitCommandEPcd,
    _GLOBAL__I__ZN12PrintCommandC2EPc,
    _GLOBAL__I__ZN9Scheduler8instanceE,
    _GLOBAL__I_wpi_error_s_IndexOutOfRange,
    _GLOBAL__I__ZN9RobotBase10m_instanceE,
    _GLOBAL__I__ZN14SmartDashboard7putDataEPcP18SmartDashboardData,
...
void _GLOBAL__D__ZN12PrintCommandC2EPc();

void _GLOBAL__D__ZN9Scheduler8instanceE();

void _GLOBAL__D_wpi_error_s_IndexOutOfRange();

void _GLOBAL__D__ZN9RobotBase10m_instanceE();

void _GLOBAL__D__ZN14SmartDashboard7putDataEPcP18SmartDashboardData();
...
void (*_dtors[])() =
    ...
    _GLOBAL__D__ZN12PrintCommandC2EPc,
    _GLOBAL__D__ZN9Scheduler8instanceE,
    _GLOBAL__D_wpi_error_s_IndexOutOfRange,
    _GLOBAL__D__ZN9RobotBase10m_instanceE,
    _GLOBAL__D__ZN14SmartDashboard7putDataEPcP18SmartDashboardData,
